...
rm(list = ls()) 
setwd("C:/Users/ezequ/Documents/Climate Change & Commodities Prices")
...
noaaout <- "C:/Users/ezequ/Documents/Climate Change & Commodities Prices"
...
length(data3$ID) #son 1433 estaciones meteorológicas iniciales
